...
def macro_loop(event=None):
    ...
    try:
        ...
        while macro_running:
            ...
            left_edge, right_edge = get_bar_edges_image(img, 570, 860, bar_b, bar_g, bar_r, rightbar_b, rightbar_g, rightbar_r) # Get bar edges
            ...
            # Action 7 (hidden): No fish, no bar, no arrow
                ...
                set_mouse(False)
                ToolTip("Tracking Direction: < (None)", 5)
        ...
        set_mouse(False)
        macro_running = False
        create_label(tab1, "Macro Crashed: {e}", 0, 1, fg="#00ff00", font=("Segoe UI", 9, "bold"), pady=(10, 5)) 
