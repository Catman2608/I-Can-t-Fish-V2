    ...
    def _enter_minigame(self):
        ...
        while self.macro_running: # Main macro loop
            ...
            if left_bar_center is not None and right_bar_center is not None:
                current_bar_size = right_bar_center - left_bar_center
                if current_bar_size > 20:  # sanity threshold
                    self.last_bar_size = current_bar_size
            if self.last_bar_size is not None:
            ...
            if bars_found and left_bar_center is not None and right_bar_center is not None:
                ...
                max_left = int(left_bar_center + deadzone + fish_left)
                max_right = int(right_bar_center - deadzone + fish_left)
            else:
                bar_center = None
                max_left = None
                max_right = None
            ...
            # ---- NOTHING FOUND ----
                ...
                pid_found = False
            # PID calculation
            if pid_found and bar_center is not None:
